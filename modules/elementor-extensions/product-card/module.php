...
/**
 * Module: Elementor Product Card Widget
 * 
 * Register dailybuddy category and Product Card widget
 */
...
class Dailybuddy_Elementor_Product_Card
{
    ...
    public function enqueue_widget_styles()
    {
        wp_enqueue_style(
            ...
            DAILYBUDDY_URL . 'modules/elementor-extensions/product-card/assets/style.css',
            array(),
            DAILYBUDDY_VERSION
        );
    }
    ...
    public function enqueue_widget_scripts()
    {
        wp_enqueue_script(
            'dailybuddy-product-card',
            DAILYBUDDY_URL . 'modules/elementor-extensions/product-card/assets/script.js',
            array('jquery'),
            DAILYBUDDY_VERSION,
            true
        );
    ...
    public function enqueue_editor_styles()
    {
        wp_enqueue_style(
            'dailybuddy-editor',
            DAILYBUDDY_URL . 'modules/elementor-extensions/product-card/assets/editor.css',
            array(),
            DAILYBUDDY_VERSION
        );
    }
