        ...
        if ($item['maybe_link'] == 'true') {
            ...
            ?>
				...
				<div class="dailybuddy-gallery-grid-item">';
					...
					.elementor-element.elementor-element-' . $section_id . ' .dailybuddy-filterable-gallery-item-wrap {
					...
					.elementor-element.elementor-element-' . $section_id . '  .dailybuddy-filterable-gallery-item-wrap {
					        width: ' . 100 / $settings["columns_" . $device] . '%;
                                                                        ...
                                                                        echo '<style id="dailybuddy-fg-inline-css-' . esc_attr($section_id) . '">' . esc_html($media_query) . '</style>';
                                                                    }
        ...
        <?php
            ...
            <script type="text/javascript">
                jQuery(document).ready(function($) {
                    $('.dailybuddy-filter-gallery-container').each(function() {
