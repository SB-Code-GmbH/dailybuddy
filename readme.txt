...
* Plugin URI now points to the wordpress.org listing.

= 1.3.1 =

* WPBuddy Connector: maintenance toggle, link scan and image audit endpoints.
* Housekeeping: WPCS cleanup pass.
...
* Accordeon Elementor Shadow Fix
* Mega Menu layout
...
* Mega Menu: Hintergrundfarbe-Control, durchgehender Gradient, Mobile Hover-Tab, Anker-Scrollspy, Item-Einblend-Animation, Body-Scroll-Lock entfernt, Width im Editor sichtbar
* Advanced Tabs: Icon-Gap fix, Active-Tab Box-Shadow Control, horizontaler Scroll-Modus mit Pfeilen, weichem Shadow und Color-Controls

= 1.2.3 =

* Fix Translate Widgets
